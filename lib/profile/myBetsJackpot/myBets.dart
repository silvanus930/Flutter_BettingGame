...
class MyBetsJackpot extends StatefulWidget {
  const MyBetsJackpot({Key? key}) : super(key: key);

  @override
  MyBetsJackpotState createState() => MyBetsJackpotState();
}

class MyBetsJackpotState extends State<MyBetsJackpot> {
  List tickets = [];
  String period = 'Today';
  var from;
  var to;
    ...
    if (from != null && to != null) {
      ...
      if (accessToken!.length > 0) {
        var url = Uri(
          ...
          path: 'betting-api-gateway/user/rest/statistics/sjp-tickets',

  ...
  handleBetType(type) {
    switch (type) {
      ...
      case 'syp':
        return 'SystemSplit';
      case 'sys':
        return '${LocaleKeys.system.tr()} ${ticket['bets']['betWS'][0]['systemX'].toString() + "/" + ticket['bets']['betWS'][0]['systemY'].toString() + (ticket['bets']['betWS'][0]['tips2BetMulti']['tipWS'].length > 0 ? " + " + ticket['bets']['betWS'][0]['tips2BetMulti']['tipWS'].length.toString() + " bankers " : "")}';
      default:
        return '';
    }
  }
                                ...
                                children: [
                                  Row(children: [
                                    Expanded(
                                      ...
                                      subtitle: Text(
                                        handleTicketType(ticket['ticketTyp']),
                                        style: TextStyle(
                                            fontSize: 12.0,
                                            color: Colors.white),
                                      ),
                                    ...
                                    Expanded(
                                      ...
                                      subtitle: Text(
                                        handleBetType(ticket['bets']['betWS'][0]
                                            ['betType']),
                                        style: TextStyle(
                                            fontSize: 12.0,
                                            color: Colors.white),

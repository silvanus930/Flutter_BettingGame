...
class EmailForm extends StatefulWidget {
  ...
  const EmailForm({Key? key, this.buttonDisabled, required this.handleSubmit})
      : super(key: key);
...
class EmailFormState extends State<EmailForm> {
  ...
  valuesObject() {
    formValues['credential'] = _emailController.text;
    ...
    widget.handleSubmit(formValues, 1);
  }
    ...
    return Form(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          TextFormField(
            ...
            validator: (input) =>
                (input!.isValidEmail() ? null : LocaleKeys.regEmailError.tr()),

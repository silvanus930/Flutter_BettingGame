...
class MatchDetailsDataAll extends StatefulWidget {
  final matchData;
  final index;
  final group;

  const MatchDetailsDataAll({Key? key, this.matchData, this.index, this.group})
      : super(key: key);

  @override
  State<MatchDetailsDataAll> createState() => _MatchDetailsDataAllState();
}

class _MatchDetailsDataAllState extends State<MatchDetailsDataAll> {
  ...
  @override
  void didUpdateWidget(MatchDetailsDataAll oldWidget) {
                        ...
                        Container(
                            ...
                            child: Row(
                                ...
                                children: [
                                  Container(
                                      width: MediaQuery.of(context).size.width,
                                      child: getMarkets(betDomainsData)),
                                ])),
                      ],
                    ),
                  ),
